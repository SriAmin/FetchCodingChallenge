...
//  strIngredient | Type: String | String that represents the ingredients to make the meal
//  strMeasure | Type: String | String that represents the amount of its corresponding ingredient to make the meal
